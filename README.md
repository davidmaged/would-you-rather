...
It is a game where you add a poll and other user answer it and see how they react to your poll.

## walk throught the app

First you login by choosing one of the available users.
Then you can start adding polls or answer available polls.
